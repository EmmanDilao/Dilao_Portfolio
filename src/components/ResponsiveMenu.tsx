...
const ResponsiveMenu = ({ open, setOpen })=> {
  return (
    <div className={`${open ? "left-0": "-left-[100%]"} fixed bottom-0 top-0 z-20 flex h-screen w-[75p%] flex-col justify-between bg-gray-950 px-4 pb-6 pt-6 text-black md:hidden rounded-r-x1 shadow-md transition-all`}>
      <div className="bg-gray-600 rounded-md p-4">
        ...
        <nav className='mt-5'>
            <ul className='flex flex-wrap text-center gap-2 items-center justify-center text-white text-x1 font-semibold'>
