...
const Navbar = () => {
  ...
  return (
    <div className='md:bg-transparent bg-gray-800 rounded-2x1'>
      <nav className='hidden md:block'>
        <ul className='flex gap-10 items-center justify-end text-white text-2x1 font-semibold'>
      ...
      <div className='flex justify-between items-center text-x1 md:hidden px-5'>
      <img src={Logo} alt="" className='w-20'/>
      {
        open ? <HiMenuAlt3 className='text-yellow-500 w-10 h-10' onClick={toggle}/> : <HiMenuAlt1
        className='text-yellow-500 w-10 h-10' onClick={toggle}/>
      }        
    </div>
